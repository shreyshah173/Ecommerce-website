...
function Cart() {
    ...
    const handleDec = (id) => {
        const upDatedCard = cart.map(item => {
            ...
            const filteredCart = upDatedCard.filter((item) => item !== null); // Filter out the null values
                                    ...
                                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                                        <div className="flex w-2/5">
                                            ...
                                            <div className="flex flex-col justify-between ml-4 flex-grow">
                                                ...
                                                <span className="text-red-500 text-xs">{cart?.application}</span>
                                                <a href="#" onClick={() => removeProduct(cart?.id)} className="font-semibold hover:text-red-500 text-gray-500 text-xs">Remove</a>
                                            </div>
                                        </div>
