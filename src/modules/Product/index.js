                ...
                <h1> name {product?.name}</h1>
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">plates = {product?.plates}</h2>
                            ...
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <span className="text-gray-600 ml-3">capacity = {product?.capacity}</span>
                                </span>
                            ...
                            <div className="flex justify-between items-center mt-20">
                                ...
                                <div className="flex ">
                                    <Link to={'/cart'} className="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded mr-2" onClick={() => handleCart(product, true)}>Buy Now</Link>
                                    <button className="flex ml-auto border border-blue-500 py-2 px-6 focus:outline-none hover:bg-blue-600 hover:text-white rounded" onClick={() => handleCart(product)}>Add to Cart</button>
                                </div>
