        ...
        <>
            <header className="text-gray-600 body-font shadow-lg">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <Link to={'/cart'}>
                        <button className="inline-flex items-center bg-blue-500 text-white-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0" style={{color:'white'}}>Go to cart
